<template>
  ...
  <body>
    ...
    <p>
      ...
      A
      players capital is worth 15 of each resource. A medium sized
      city is
      worth 6 of each resources. A small city is worth 4 of each resource. All cities are worth 1 production point.
      City size can be determined by the number of towers present on the physical piece. 5 towers is a capital
      size. 4 towers is a medium city and 3 towers is a small city.
    </p>
